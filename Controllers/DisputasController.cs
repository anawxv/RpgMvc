...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://ANAVIEIRA.somee.com/RpgApi/Disputas/";
        [HttpGet]
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://ANAVIEIRA.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://ANAVIEIRA.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://ANAVIEIRA.somee.com/RpgApi/Disputas/DisputaEmGrupo";
